import { DrawingApp } from "./classes/DrawingApp.js";
import { ToolTypes } from "./classes/ToolBar.js";
...
//           if (this.mouseWithinSelection(mouseX, mouseY, drawing) === SelectionPosition.NONE) return;
//
...
//         const font: string = this.actions.resizing && this.selectedDrawingIndex === i ? drawing.resizedFont : drawing.font;
...
//       }
//
//       const path: Path2D = this.actions.resizing && this.selectedDrawingIndex === i ? drawing.resizedPath as Path2D : drawing.path;
//
